...
import OptionsMenu from "@web/@core/components/option-menu";
import { OptionType } from "@web/@core/components/option-menu/types";
// ** Custom Components Imports
import Sidebar from "@web/@core/components/sidebar";
// ** Hooks
...
import {
  ...
  MailLabelType,
  MailType,
} from "@web/types/apps/emailTypes";
