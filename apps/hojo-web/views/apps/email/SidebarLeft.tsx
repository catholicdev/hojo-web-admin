...
import CustomBadge from "@web/@core/components/mui/badge";
// ** Types
import { CustomBadgeProps } from "@web/@core/components/mui/badge/types";
import { MailFolderType, MailLabelType, MailSidebarType } from "@web/types/apps/emailTypes";
