...
// ** Types
import { ChatContentType } from "@web/types/apps/chatTypes";
import SendMsgForm from "@web/views/apps/chat/SendMsgForm";
import UserProfileRight from "@web/views/apps/chat/UserProfileRight";
