...
import CardStatisticsCharacter from "@web/@core/components/card-statistics/card-stats-with-image";
// ** Type Import
import { CardStatsCharacterProps } from "@web/@core/components/card-statistics/types";
