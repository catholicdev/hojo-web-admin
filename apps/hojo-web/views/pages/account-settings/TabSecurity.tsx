...
import ChangePasswordCard from "@web/views/pages/account-settings/security/ChangePasswordCard";
// ** Demo Components
import CreateApiKey from "@web/views/pages/account-settings/security/CreateApiKey";
import TwoFactorAuthentication from "@web/views/pages/account-settings/security/TwoFactorAuthentication";
