...
// ** Demo Tabs Imports
import TabAccount from "@web/views/pages/account-settings/TabAccount";
import TabBilling from "@web/views/pages/account-settings/TabBilling";
import TabConnections from "@web/views/pages/account-settings/TabConnections";
import TabNotifications from "@web/views/pages/account-settings/TabNotifications";
import TabSecurity from "@web/views/pages/account-settings/TabSecurity";
