...
// ** Hook Imports
import { useSettings } from "@web/@core/hooks/useSettings";
import DialogTabBilling from "@web/views/pages/dialog-examples/create-app-tabs/DialogTabBilling";
import DialogTabDatabase from "@web/views/pages/dialog-examples/create-app-tabs/DialogTabDatabase";
// ** Tab Content Imports
import DialogTabDetails from "@web/views/pages/dialog-examples/create-app-tabs/DialogTabDetails";
import DialogTabFramework from "@web/views/pages/dialog-examples/create-app-tabs/DialogTabFramework";
