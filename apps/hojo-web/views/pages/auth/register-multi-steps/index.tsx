...
import StepAccountDetails from "@web/views/pages/auth/register-multi-steps/StepAccountDetails";
import StepBillingDetails from "@web/views/pages/auth/register-multi-steps/StepBillingDetails";
// ** Step Components
import StepPersonalInfo from "@web/views/pages/auth/register-multi-steps/StepPersonalInfo";
