...
// ** Types
import { PricingDataType, PricingTableRowType } from "@web/@core/components/plan-details/types";
              ...
              {data.pricingTable.rows.map((row, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell
                    align="center"
                    sx={{
                      "& svg": { verticalAlign: "middle", color: row.starter ? "primary.main" : "text.disabled" },
                    }}>
