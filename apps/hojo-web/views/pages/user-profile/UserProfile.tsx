...
} from "@web/@fake-db/types";
import UserProfileHeader from "@web/views/pages/user-profile/UserProfileHeader";
import Connections from "@web/views/pages/user-profile/connections";
import Profile from "@web/views/pages/user-profile/profile";
import Projects from "@web/views/pages/user-profile/projects";
// ** Demo Components
import Teams from "@web/views/pages/user-profile/teams";
